...
class SellerEarningScreen extends StatefulWidget
{
  const SellerEarningScreen({Key? key}) : super(key: key);

  @override
  _SellerEarningScreenState createState() => _SellerEarningScreenState();
}




class _SellerEarningScreenState extends State<SellerEarningScreen>
{
